...
> **Note:** Note: This lab requires the appropriate Copilot Studio license. If you do not have access, please enquire with IT about how to obtain the required license before attempting this lab.
...
> **Note:** Governance reminder: This exercise is for mock training only. Do not connect the agent to real procurement, legal, HR, supplier, financial, or operational systems during the class unless the environment has been formally approved.
