---
lab:
    title: 'Lab 08: Create a knowledge agent with Agent Builder'
    description: 'Build a simple knowledge agent using approved training documents and test with sample questions.'
    level: '100'
    duration: '30 minutes'
    isLab: true
    primaryTopics: 'Microsoft 365 Copilot, Agent Builder'
---

# Lab 08 - Create a knowledge agent with Agent Builder
...
| --- | --- | --- |
| 1 | Where is the weekly KPI file stored? | Answer should mention the shared training folder bp copilot or the mock training context. |
