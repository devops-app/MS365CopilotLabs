---
lab:
    title: 'Lab 09: Design and test an agent with Copilot Studio'
    description: 'Design a Procurement Support Agent, configure knowledge, run test cases, and document improvements.'
    level: '100'
    duration: '40 minutes'
    isLab: true
    primaryTopics: 'Microsoft Copilot Studio'
---
...
> [!WARNING]
> This exercise is for mock training only. Do not connect the agent to real procurement, legal, HR, supplier, financial, or operational systems during the class unless the environment has been formally approved.
