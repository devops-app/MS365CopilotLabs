...
- [ ] After joining the meeting, open the meeting controls, select **More actions**, then start transcription or enable the Copilot meeting feature if it is available in the tenant.
