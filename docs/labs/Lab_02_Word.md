---
lab:
    title: 'Lab 02: Draft, improve, and summarize a document with Copilot in Word'
    description: 'Use Copilot in Word to create a report from a source document, rewrite content, convert content into a table, and summarize the final document.'
    level: '100'
    duration: '30 minutes'
    isLab: true
    primaryTopics: 'Microsoft Word, Microsoft 365 Copilot'
---
...
- [ ] Add the project charter file from **bp copilot / sample data** as source content.
...
Use professional language suitable for BP Malaysia leadership training.
```
...
- [ ] Open the Copilot pane from the Home tab.
- [ ] Submit the following prompt.
...
> [!WARNING]
> Before completing the lab, manually verify that the generated summary aligns with the report and does not introduce facts that are not in the source document.
