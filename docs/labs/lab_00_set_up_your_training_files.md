...
> **Note:** Validation: If files do not appear in Copilot file search, refresh the browser, confirm OneDrive sync, and use the file picker instead of typing the full file name.
...
> **Note:** Validation: If the General label is unavailable, ask the instructor which training-approved label to use and do not apply a higher or lower label without guidance.
