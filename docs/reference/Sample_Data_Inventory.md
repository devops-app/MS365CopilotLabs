---
lab:
    title: 'Sample Data Inventory'
    description: 'Reference list for the mock files used by the BP Malaysia Copilot labs.'
    level: '100'
    duration: '5 minutes'
    isLab: true
    primaryTopics: 'OneDrive, sample data'
---
